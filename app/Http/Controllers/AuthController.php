...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if(!$checkPassword) {
            return $this->responseDTO->response(array('status' => 400, 'message' => 'Clave incorrecta'), null);
        }
    ...
    public function logout(){
        ...
        return $this->responseDTO->response(array('status' => 200, 'message' => 'Sesión Cerrada Correctamente'), null);
    }
}
